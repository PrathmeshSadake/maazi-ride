...
const LocationInput = ({ placeholder, type }: InputItemProps) => {
  ...
  // For debugging - set data attributes
  useEffect(() => {
  ...
  return (
    <div className='flex items-center space-x-2 bg-gray-100 py-2 px-4 rounded-lg'>
      ...
      {isLoaded ? (
        ...
        <div className='w-full text-gray-500'>Loading Google Places...</div>
      )}
    </div>
  );
};
