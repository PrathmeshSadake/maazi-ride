...
export default function RideDetailsPage() {
  ...
  const formattedDate = format(new Date(ride.departureDate), "dd MMMM yyyy");
  const createdAtDistance = formatDistanceToNow(new Date(ride.departureDate), {
    addSuffix: true,
  });
  ...
  return (
    <div className='p-4 max-w-md mx-auto pb-20'>
      ...
      <div className='fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4 max-w-md mx-auto'>
        ...
        >
          {bookingStatus === "loading" ? "Processing..." : "Book this ride"}
        </button>
